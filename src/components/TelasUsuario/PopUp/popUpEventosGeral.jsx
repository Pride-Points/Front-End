  ...
  useEffect(() => {
    const buscarEmpresaPorId = async (token) => {
      try {
        ...
        const response = await axios.get(`http://18.232.115.67:8080/empresas/${idEmpresa}`, {
          headers: {
  ...
  useEffect(() => {
    const buscarNotas = async (token) => {
      try {
        ...
        const response = await axios.get(`http://18.232.115.67:8080/empresas/media/${idEmpresa}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
  ...
  useEffect(() => {
    const buscarEventos = async (token) => {
      try {
        ...
        const response = await axios.get(`http://18.232.115.67:8080/eventos/empresa/${idEmpresa}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
